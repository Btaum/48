...
function settingsPage() {
  ...
  return `${assetManagerHtml()}<section class="settings-layout"><section class="panel"><div class="panel-title"><h2>Strategy Settings</h2><span class="pill pill-data">EMA50/200 + MACD + Memory Cloud</span></div><p class="warning-box"><b>V68:</b> LIVE-ARMED build. Closed-candle only, Market Memory similar-history pullback, limit-first execution, then structure SL/TP before entry. LIVE requires API test + wallet/position sync + explicit confirmation. SL is structure-first; lots reduce when SL is wide.</p><form id="strategySettingsForm" class="settings-grid">
