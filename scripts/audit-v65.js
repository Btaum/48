...
const serverTokens = [
  ...
  'V65 paper-only lock: live order execution disabled in this build',
  'pendingCreatedCandleTime',
  'Paper limit filled only from a closed 5m candle after the order was placed.',
  'lotsPurchased',
  'confluenceScore',
  'v65-ema50-200-memory-cloud-paper-lock'
];
...
assert.equal(pkg.version, '6.5.0', 'package version must be 6.5.0');
...
console.log('PASS: V65 audit confirmed EMA50/200-only chart, Market Memory cloud, MACD divergence/timing, paper lock, closed-candle limit fills, structure SL-first sizing, trade totals, UI fields, and defaults.');
