...
ok(pkg.version === '6.0.0', 'Package must be version 6.0.0.');
...
ok(settings.requirePullbackForExecution === false, 'Do not require a second pullback after institutional EMA50 pullback confirmation.');
...
if (failures.length) {
  console.error('V60 audit failed:\n- ' + failures.join('\n- '));
  process.exit(1);
}
console.log('V60 audit passed: institutional EMA/MACD gates, chart visuals, style labels, dynamic TP/SL, and profit guards are consistent.');
